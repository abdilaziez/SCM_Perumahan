...
<html lang="en">
    <head>
        ...
        <title>Developer - Barang Masuk</title>
    ...
    <div class="modal-dialog">
        ...
        <br>
        <input type="text" name="estimasi" placeholder="Estimasi Waktu" class="form-control" required>
        <br>
        <input type="text" name="status" placeholder="Status Pembangunan" class="form-control" required>
        <br>
